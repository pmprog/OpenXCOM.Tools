...
namespace DSShared.Old2
{
	public delegate void OptionClickDelegate(object sender, OptionClickEventArgs e);
	...
	public abstract class CustomList:Control
	{
		...
		public event OptionClickDelegate OptionClick;
		...
		public virtual void MakeWebpage(StreamWriter sw)
		{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			{
				OnRenderLine(g,y,rowHeight,collection[i],i,smallFont);
				y+=rowHeight;
			}
		...
		protected virtual void OnRenderLine(Graphics g, float y, float height,object p,int rowNum,Font f)
		{
...
//					}
		...
		protected virtual void readChar(Keys key){}
	...
	public class OptionClickEventArgs:EventArgs
	{
		...
		public OptionClickEventArgs(string option, object item,int column,MouseEventArgs mea)
		{
			this.option=option;
			this.item=item;
			this.column=column;
		...
		public OptionClickEventArgs():this(null,null,0,null){}
	...
	public class StrProperty:IComparable
	{
		public object name;
		public object[]Index;
		...
		{
			if(other is StrProperty)
				return name.ToString().CompareTo(((StrProperty)other).name.ToString());
			return -1;
		}
		...
		public string Value(object o, bool cursor)
		{
			string s =Value(o);

			if(!cursor && addText.Length>0)
				return s.Replace(addText,"");
			return s;
		}
