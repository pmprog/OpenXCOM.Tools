...
namespace MapView
{   
	//enums for Collapsible Splitter
	public enum DotStyles{Mozilla,XP,Win9x,DoubleDots,Lines}
	public enum SplitterState{Collapsed,Expanding,Expanded,Collapsing}
