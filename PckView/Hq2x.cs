...
namespace PckView
{
	public unsafe class Hq2xClass
	{
		private static int[] LUT16to32 = new int[65536];
		private static int[] RGBtoYUV = new int[65536];
		...
		private const  int trY   = 0x00300000;
		private const  int trU   = 0x00000700;
		private const  int trV   = 0x00000006;
		...
		static void Interp1(byte * pc, int c1, int c2)
		{
			*((int*)pc) = (c1*3+c2) >> 2;
		}

		static void Interp2(byte * pc, int c1, int c2, int c3)
		{
			*((int*)pc) = (c1*2+c2+c3) >> 2;
		}

		static void Interp5(byte * pc, int c1, int c2)
		{
			*((int*)pc) = (c1+c2) >> 1;
		}

		static void Interp6(byte * pc, int c1, int c2, int c3)
		{
		...
		static void Interp7(byte * pc, int c1, int c2, int c3)
		{
			//*((int*)pc) = (c1*6+c2+c3)/8;
		...
		static void Interp9(byte * pc, int c1, int c2, int c3)
		{
		...
		static void Interp10(byte * pc, int c1, int c2, int c3)
		{
		...
		public static bool Diff(int w1a,int w2a)
		{
			uint w1 = (uint)w1a;
			uint w2 = (uint)w2a;
		...
		public static unsafe void hq2x_32(byte * pIn, byte * pOut, int Xres, int Yres, int BpL )
		{
			int  i, j, k;
